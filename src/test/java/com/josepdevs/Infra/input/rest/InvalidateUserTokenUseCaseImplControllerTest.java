...
import com.josepedevs.infra.input.rest.user.InvalidateTokenController;

@ExtendWith(MockitoExtension.class) //tells JUnit to use Mockito for mocking dependencies
public class InvalidateUserTokenUseCaseImplControllerTest {
	 
		@Mock
		private InvalidateUserTokenUseCaseImpl invalidateUseCase; //= mock(InvalidateToken.class, RETURNS_DEEP_STUBS);
