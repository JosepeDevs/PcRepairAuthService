...
public class RestGetAllRegisteredControllerTest {
    ...
    @Mock
    private GetAllAuthenticationDataUseCaseImpl useCase; //mock dependencies
    ...
    void getAll_ShouldReturnAListAndResponseStatusOk() throws Exception {
		...
		final var mockDataList = List.of(
        ...
        final var result = controller.getAllRegistered(jwtToken);
